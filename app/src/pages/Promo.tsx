            ...
            <div className="relative overflow-hidden bg-white z-0 dark:bg-gray-800">
                ...
                <div className="max-w-3xl flex flex-col gap-20 px-8 pb-8 pt-20 m-auto">
                    ...
                    <section className="flex flex-col gap-4">
                        <div>
                            <h1 className="text-6xl dark:text-white text-center">
                                Stay in touch with your own <span className="text-cyan-500 font-bold">happiness.</span>
                            </h1>
                        </div>
                        <div>
                        ...
                        <div className="relative flex justify-center m-auto h-[550px] w-[265px] rounded-[45px]">
                            <div className="-z-10 opacity-75 absolute h-[540px] w-screen bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-cyan-500"></div>
                            <div className="">
                    ...
                    <section className="flex flex-col-reverse gap-4 justify-center sm:flex-row">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <h1 className="text-3xl dark:text-white">
                                Explore yourself one happiness bullet at a time
                            </h1>
                            <h1 className="text-xl text-gray-400">
                                Communicate with your future self through your current thoughts.
                            </h1>
                        </div>
                    </section>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <details className="border-b-2 duration-300 dark:text-white">
                                ...
                                <div className="py-6 border-gray-400 text-sm ">
                                    <p>
                                        If you're looking for a secure and convenient digital platform to track your
                                        thoughts and reflections, access prompts and inspiration, and customize your
                                        entries in different formats, our journaling app may be a good fit for you. By
                                        investing time and effort into consistent journaling, you can gain insights into
                                        your thoughts and emotions. Try it out and see if it works for you!
                                    </p>
                                </div>
                            </details>
                            {/* FAQ 2 */}
                            ...
                            <details className="border-b-2 duration-300 dark:text-white">
                                <summary className="text-xl cursor-pointer">
                                    What is the ideal way to interact with the app?
                                </summary>
                                <div className="py-6 border-gray-400 text-sm">
                            ...
                            <details className="border-b-2 duration-300 dark:text-white">
                                ...
                                <div className="py-6 border-gray-400 text-sm">
                                    <p>
                                        To provide a clean, minimal journaling platform that is available across all
                                        devices.
                                    </p>
                                </div>
                            </details>
                            ...
                            <div className="flex flex-row gap-x-10 justify-center">
                                <div>
                                    ...
                                    <div className="flex flex-row justify-evenly mt-2">
                                        <SocialIcon
                                            url="https://www.linkedin.com/in/allison-moyer-526255212/"
                                        ...
                                        />
                                        <SocialIcon
                                            url="https://github.com/al-moy729"
                                            style={{ height: 40, width: 40 }}
                                            bgColor="#06b6d4"
                                        />
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-row justify-evenly mt-2">
                                        <SocialIcon
                                            url="https://www.linkedin.com/in/brady-waughen/"
                                            style={{ height: 40, width: 40 }}
                                            bgColor="#06b6d4"
                                        />
                                        <SocialIcon
                                            url="https://twitter.com/bradywaughen"
                                            style={{ height: 40, width: 40 }}
                                            bgColor="#06b6d4"
                                        />
                                        <SocialIcon
                                            url="https://github.com/BradyWaughen"
                                            style={{ height: 40, width: 40 }}
                                            bgColor="#06b6d4"
                                        />
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-row justify-evenly mt-2">
                                        <SocialIcon
                                            url="https://www.linkedin.com/in/dinesh-umasankar-78354b184/"
                                            style={{ height: 40, width: 40 }}
                                            bgColor="#06b6d4"
                                        />
                                        <SocialIcon
                                            url="https://twitter.com/DineshUmasankar"
                                            style={{ height: 40, width: 40 }}
                                            bgColor="#06b6d4"
                                        />
                                        <SocialIcon
                                            url="https://github.com/dineshUmasankar"
                                            style={{ height: 40, width: 40 }}
                                            bgColor="#06b6d4"
                                        />
                                    </div>
                    ...
                    <section>
                        <div className="flex flex-col">
                            ...
                            <div className="flex flex-col gap-y-2 mt-2">
                                <a
                                    href="https://github.com/gratitude-notes/gratitude-notes-core/blob/master/phase-1/Phase1-RequirementsReview.pdf"
                                    className="transition ease-in-out
                                bg-cyan-500 hover:-translate-y-1 hover:scale-110 duration-300
                                ...
                                <a
                                    href="https://github.com/gratitude-notes/gratitude-notes-core/blob/master/phase-2/Phase%202-Design%20Review%26Project%20Milestone2.pdf"
                                    className="transition ease-in-out
                                bg-cyan-500 hover:-translate-y-1 hover:scale-110 duration-300
                                text-white font-bold py-2 px-4 rounded text-center"
                                >
                                ...
                                <a
                                    href="https://github.com/gratitude-notes/gratitude-notes-core/blob/master/phase-3/Phase3-ProjectPlanner.pdf"
                                    className="transition ease-in-out
                                bg-cyan-500 hover:-translate-y-1 hover:scale-110 duration-300
                                text-white font-bold py-2 px-4 rounded text-center"
                                >
                    ...
                    <section>
                        <div className="flex flex-col gap-4">
                            ...
                            <a
                                href="https://github.com/gratitude-notes/gratitude-notes-core"
                                className="transition ease-in-out
                               bg-cyan-500 hover:-translate-y-1 hover:scale-110 duration-300
                               text-white font-bold py-2 px-4 rounded text-center"
                            >
