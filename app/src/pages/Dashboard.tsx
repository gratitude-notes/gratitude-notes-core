...
const Dashboard: React.FC = () => {
    ...
    const renderCurrent = () => {
        switch (viewState) {
            case 'Write':
                return <WriteNoteModal updateViewState={updateViewState} />;
            case 'Settings':
                return <SettingsModal updateViewState={updateViewState} />;
            case 'Weekly Dosage':
                return <WeekInReviewModal updateViewState={updateViewState} />;
            default:
                return (
                    <>
                        ...
                        <div className="visible md:hidden">{isWeekCardVisible && <WeekCard />}</div>
                        ...
                        >
                            <div
                                className="fixed h-full border-gray-400
                            ...
                            <div
                                className="xl:pr-[100px] xl:w-[400px]
                              2xl:pr-[200px]"
                            >
                                <RightSidebar />
                            </div>
