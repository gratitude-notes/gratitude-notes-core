    ...
    return (
        <>
            <div className="hidden sm:flex mx-auto select-none">
                <button
                    onClick={() => updateViewState('Write')}
                    className="hidden md:inline w-40 rounded-full p-2 font-bold text-white bg-cyan-500"
                >
                    Write
                </button>
                <button
                    onClick={() => updateViewState('Write')}
                    className="hidden sm:flex md:hidden rounded-full p-2 bg-cyan-500"
                >
