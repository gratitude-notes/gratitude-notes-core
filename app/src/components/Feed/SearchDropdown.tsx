...
const SearchDropdown: React.FC<SearcDropdownProps> = ({ handleSearchCategoryChange }) => {
    ...
    return (
        <div ref={dropdownVisible.ref} className="relative flex justify-center items-center select-none">
            <div
                onClick={handleDropdown}
                className={`${
                    dropdownVisible.isComponentVisible
                        ? 'bg-gray-200 dark:bg-gray-900 outline outline-1 outline-gray-400'
                        : ''
                }
            ...
            {/* Dropdown Menu */}
            <div
                className={`${dropdownVisibilityState} absolute top-[112%] w-full z-50 rounded-lg border border-gray-400 dark:border-gray-600`}
            >
                <div className="flex flex-col gap-1 bg-gray-200 dark:bg-gray-900 rounded-lg text-black dark:text-white">
                    <div
                        onClick={() => {
                            handleSearchCategoryChange('All');
                    ...
                    <div
                        onClick={() => {
                            handleSearchCategoryChange('Content');
                            setDropdownCategory('Content');
                        }}
                    ...
                    <div
                        onClick={() => {
                            handleSearchCategoryChange('Day');
                            setDropdownCategory('Day');
                        }}
                    ...
                    <div
                        onClick={() => {
                            handleSearchCategoryChange('Month');
                            setDropdownCategory('Month');
                        }}
                    ...
                    <div
                        onClick={() => {
                            handleSearchCategoryChange('Date');
                            setDropdownCategory('Date');
                        }}
                    ...
                    <div
                        onClick={() => {
                            handleSearchCategoryChange('Year');
                            setDropdownCategory('Year');
                        }}
                    ...
                    <div
                        onClick={() => {
                            handleSearchCategoryChange('Score');
                            setDropdownCategory('Score');
                        }}
                    ...
                    <div
                        onClick={() => {
                            handleSearchCategoryChange('Location');
                            setDropdownCategory('Location');
                        }}
