                ...
                <div className="py-1">
                    ...
                    <div className="flex flex-col gap-2 pb-2">
                        <ul className="list-disc text-sm pl-4">
                            <li>
                                <strong>content</strong> - ex: "happy"
                            </li>
                            <li>
                                <strong>day</strong> - ex: "monday"
                            </li>
                            <li>
                                <strong>month</strong> - ex: "march"
                            </li>
                            <li>
                                <strong>date</strong> - ex: "15"
                            </li>
                            <li>
                                <strong>year</strong> - ex: "2020"
                            </li>
                            <li>
                                <strong>score</strong> - ex: "2"
                            </li>
                        </ul>
