//https://www.googleapis.com/geolocation/v1/geolocate?key=AIzaSyAiZZ6nKWPvuPwfKd5uf15HKFqty4omji4
...
const LocationModal: React.FC<SettingsModalState> = ({updateViewState}) => {
