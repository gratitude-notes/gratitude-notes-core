...
const ShareButton: React.FC<ShareButtonProps> = ({ shareText, shareDate, shareAddress }) => {
    ...
    return (
        <button
            ...
            className={clsx(
                shareAPI
                    ? 'hover:bg-green-700 hover:bg-opacity-20 hover:text-green-500 p-2 hover:rounded-full'
                    : 'hover:bg-orange-700 hover:bg-opacity-20 hover:text-orange-500 p-2 hover:rounded-full'
            )}
        >
            {shareButtonIcon}
        </button>
