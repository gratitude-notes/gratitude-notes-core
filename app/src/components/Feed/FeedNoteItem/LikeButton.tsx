...
const LikeButton: React.FC<LikeButtonProps> = ({ isFavorited, bulletDocID }) => {
    ...
    return (
        <>
            {isFilled ? (
                <button
                    className="hover:bg-pink-700 hover:bg-opacity-20 p-2 hover:rounded-full"
                ...
                <button
                    className="hover:bg-pink-700 hover:bg-opacity-20 hover:text-pink-500 p-2 hover:rounded-full"
                    onClick={onClickLikeButton}
                >
                    <BsHeart size={15} />
                </button>
