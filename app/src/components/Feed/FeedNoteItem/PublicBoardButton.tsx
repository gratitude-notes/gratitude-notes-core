...
const PublicBoardButton: React.FC<PublicBoardButtonProps> = ({ isPublic, bulletDocID }) => {
    ...
    const onClickPublicYesButton = async () => {
        try {
            if (bulletDocID && session && session.user) {
                ...
                const publicBulletsDocRef = doc(
                    fb_firestore,
                    'users',
                    session.user.uid,
                    'public_notes',
                    copyOfPersonalBullet?.bulletDocID
                );
    ...
    return (
        <>
            {isFilled ? (
                <button
                    className="hover:bg-cyan-700 hover:bg-opacity-20 hover:text-cyan-500 p-2 hover:rounded-full"
                    ...
                    <div className="flex items-center justify-center min-h-screen">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg px-4 pt-5 pb-4 text-center overflow-hidden shadow-xl transform transition-all w-11/12 sm:max-w-sm sm:w-full sm:p-6">
                                ...
                                <div className="mt-3 text-center sm:mt-5">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-400">
                                            Are you sure you want to post this note to your Public Board? This means
                                            others can view this note.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-5 sm:mt-6">
                                <button
                                    className="inline-flex justify-center px-4 py-2 ml-3 text-sm font-medium text-black bg-gray-100 border border-transparent rounded-md hover:bg-gray-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-gray-500"
                                    onClick={() => setPublicConfirmationOpen(false)}
                                >
                                    Cancel
                                </button>
                                <button
                                    className="inline-flex justify-center px-4 py-2 ml-3 text-sm font-medium text-black bg-gray-100 border border-transparent rounded-md hover:text-white hover:bg-cyan-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-gray-500"
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg px-4 pt-5 pb-4 text-center overflow-hidden shadow-xl transform transition-all w-11/12 sm:max-w-sm sm:w-full sm:p-6">
                            <div>
                                <div className="mt-3 text-center sm:mt-5">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-400">
                                            Are you sure you want to delete this note from your Public Board? This means
                                            this note will now only be visible on your Private Board.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-5 sm:mt-6">
                                ...
                                <button
                                    className="inline-flex justify-center px-4 py-2 ml-3 text-sm font-medium text-white bg-red-500 border border-transparent rounded-md hover:bg-red-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-gray-500"
