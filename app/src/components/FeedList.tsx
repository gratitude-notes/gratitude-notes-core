    ...
    return (
        <>
            ...
            <ol className="relative border-l border-gray-200 dark:border-gray-700">
                    ...
                    <NoteItem date="March 7, 2023" time="4:35PM" note="adipiscing elit duis tristique sollicitudin nibh sit amet commodo nulla facilisi nullam vehicula ipsum a" keywordsStr={["smiley", "photography"]} score={0}/>
