...
const EditorToolbarDropdown = ({editor, blockType, blockTypeToBlockName} : {editor: LexicalEditor, blockType: keyof typeof blockTypeToBlockName, 
    ...
    return (
        <div ref={dropdownVisible.ref} className="relative flex justify-center items-center cursor-pointer text-black dark:text-white
