...
type DotsFirstHalfOfSequenceProps = {
  from: number,
  durationInFrames: number
}

const DotsFirstHalfOfSequence: React.FC<DotsFirstHalfOfSequenceProps> = ({from, durationInFrames}) => {
	return (
		<Explosion>
...
export default DotsFirstHalfOfSequence;
