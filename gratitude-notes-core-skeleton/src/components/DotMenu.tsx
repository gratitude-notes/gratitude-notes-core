...
const DotMenu: React.FC = () => {  
        ...
        return (
            <div ref={ref} >
                <button onClick={handleThemeButton} className="inline-block absolute right-6 top-2 bg-white rounded-lg hover:bg-neutral-200">
                    <BsThreeDots aria-hidden="true" size={20}/>
                </button>

                {/* Dropdown Menu */}
                <div className={`${twVisible} inline-block absolute right-0 bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none`}>
