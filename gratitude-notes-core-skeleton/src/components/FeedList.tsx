    ...
    return (
        <>
            ...
            <ol className="relative border-l border-gray-200 dark:border-gray-700">
                    ...
                    Tomorrow is a new day and I'm looking forward to what it brings. Hopefully, it will be less stressful than today. But either way, I know that I can handle it and make time for self-care." keywordsStr={["happy", "photography"]} score={5}/>
                    <NoteItem date="March 7, 2023" time="4:35PM" note="adipiscing elit duis tristique sollicitudin nibh sit amet commodo nulla facilisi nullam vehicula ipsum a" keywordsStr={["happy", "photography"]} score={-5}/>
                    <NoteItem date="March 7, 2023" time="10:30PM" note="eget felis eget nunc lobortis mattis aliquam faucibus purus in massa tempor nec feugiat nisl" keywordsStr={["happy", "photography"]} score={1}/> 
                    <NoteItem date="March 7, 2023" time="11:15PM" note="ac placerat vestibulum lectus mauris ultrices eros in cursus turpis massa tincidunt dui ut ornare" keywordsStr={["happy", "photography"]} score={4}/>
